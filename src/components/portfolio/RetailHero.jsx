  ...
  return (
    <>
      <section className="portfolio__area-2">
        <div
          className="container g-0  pt-100 pb-140"
          ...
          <div className="row">
            <div className="col-xxl-12">
              <div className="sec-title-wrapper text-anim">
                <div>
                  <h2 className="title-anim sec-title-33">Retail</h2>
                </div>
            ...
            <div className="swiper-wrapper">
              <SwiperSlide>
                ...
                <div className="slide-img">
                  ...
                  <div className="slide-content" style={{width:"90%"}}>
                    ...
                    <p>
                      In the modern retail environment, consumers are
                      well-informed and expect intuitive, engaging, and
                      informative experiences when they shop. Retailers need
                      solutions that can help them delight their customers with
                      personalized experiences, empower their workforce to
                      provide differentiated customer experiences, optimize
                      their supply chain with intelligent operations, and
                      transform their products and services. 
                      <br/>
                      Retail represents
                      one of the largest industries and touches almost
                      everyone’s lives. It is 33% of global Gross Domestic
                      Product (GDP), and its data is the “demand signal for the
                      world.”
                    </p>
