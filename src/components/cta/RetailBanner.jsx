...
=
              <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                <div className="cta__content-4" style={{paddingBottom:"50px"}}>
                  <h2 className="cta__title-4 title-anim" >
                  Microsoft Cloud for Retail
                  </h2>
                  <p>Trusted cloud to accelerate innovation for sustainable growth</p>
                </div>
              </div>
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                <div className="cta__content-4 text-anim" style={{paddingBottom:"0px"}}>
                  <Link className="btn-started" target="_blank" href="https://www.microsoft.com/en-us/industry/retail/microsoft-cloud-for-retail" style={{margin:"auto",marginTop:"30px"}}>
                    Learn More{" "}
                    <span>
