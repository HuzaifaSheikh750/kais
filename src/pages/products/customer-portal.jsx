...
const TeamDetails = () => {
  ...
  return (
    <div>
      <Head>
        <title>Customer Portal | KAISPE</title>
                ...
                <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                  <div className="sec-title-wrapper pt-120">
                    ...
                    <h3
                      ...
                      ref={charAnim2}
                    >
                      Empower Your Customers - Blazing-fast Self-service
                      Experience
                    </h3>
                    <p>
                      A Secure, Collaborative, and Intelligent KAISPE Customer
                      Portal provides your clients with a convenient,
                      self-service option for accessing information and support,
                      which can improve your overall experience with your
                      business.
                    </p>
                    <p>
                      ...
                      tracking, and product documentation. You can elevate your
                      customer service to the next level by providing your
