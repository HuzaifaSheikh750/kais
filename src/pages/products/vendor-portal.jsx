...
const TeamDetails = () => {
  ...
  return (
    <div>
      <Head>
        <title>Vendor Portal | KAISPE</title>
              ...
              <div className="row">
                ...
                <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                  <div className="sec-title-wrapper pt-120">
                    ...
                    <p>
                      Sort Your Raw Data Of Vendors By Bringing It To One
                      Platform Of The Vendor Portal By KAISPE. Maximize Your
                      Business Communication And Efficiency To Streamline
                      Purchase Orders, Contracts, And Vendor Details.
                    </p>
                    <p>
                      Say Yes To The Platform That Revolutionizes The Way
                      Businesses Interact With Vendors, Manage Purchases, And
                      Optimize Supply Chains. Our Vendor Portal Empowers
                      Businesses To Forge Stronger Vendor Relationships And
                      Drive Success By Simplifying Complex Procurement
                      Processes, Enhancing Collaboration, And Maximizing
